...
public class VoiceActivity extends AppCompatActivity implements EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callbackMethod = getIntent().getStringExtra("callBackMethod");
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new JsCallBackEvent(callbackMethod, txtResult.getText()));
                finish();
            }
        });
        if (enableOffline) {
        ...
        ToastUtils.showShort("请点击按钮后开始说话");
    }
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (!recogResult.hasError()) {
            ...
            if (resultsRecognition.length > 0) {
                String text = resultsRecognition[0];
